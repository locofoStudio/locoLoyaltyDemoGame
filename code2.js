...
gdjs.Start_95countdownCode.asyncCallback17450900 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.Start_95countdownCode.asyncCallback17450900(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Start_95countdownCode.asyncCallback17457388 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Start_95countdownCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Start_95countdownCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.Start_95countdownCode.asyncCallback17457388(runtimeScene, asyncObjectsList)));
}
}
